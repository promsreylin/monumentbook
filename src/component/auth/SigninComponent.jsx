    ...
    <div className="mx-auto grid gap-4 sm:grid-cols-2 md:grid-cols-5 lg:grid-cols-5 px-4 max-w-7xl sm:static sm:px-6 lg:px-8">
      <Form onFinish={onFinish} form={form} layout="vertical" className="sm:col-span-2 md:col-span-2 lg:col-span-2 ">
        <div className="grid pt-10 justify-items-center">
          <img className="w-auto object-cover h-28" src={Logo} alt="bgLogin" />
        </div>
        ...
        <Form.Item name="password" label="Password" rules={[{ required: true, message: "Please enter your password!" }]}>
          <Input.Password size="large" placeholder="Please Enter password." autoComplete="off" />
        </Form.Item>
        <Form.Item name="remember" valuePropName="checked" noStyle className="">
        ...
        <span className="text-sm text-gray-600">
          ...
          <Link to="/sign-up" className="text-[#363B9D] ml-2 hover:underline focus:outline-none">Sign Up
          </Link>
        </span>
        <Divider>
